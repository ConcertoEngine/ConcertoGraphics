...
#ifdef CONCERTO_GRAPHICS_RHI_BASE_BUILD
	#define CONCERTO_GRAPHICS_RHI_BASE_API CONCERTO_EXPORT
#else
	#define CONCERTO_GRAPHICS_RHI_BASE_API CONCERTO_IMPORT
#endif // CONCERTO_GRAPHICS_RHI_BASE_BUILD
