...
//		UInt32 swapchainImageIndex = _swapchain->AcquireNextImage(frame._presentSemaphore, frame._renderFence,
//			1000000000);
...
//	{
//		UInt32 windowWidth = _window.GetWidth();
//		UInt32 windowHeight = _window.GetHeight();
//		VkViewport viewport{
...
//	}
//
//	void VulkanRenderer::Resize(UInt32 width, UInt32 height)
//	{
//		_device.WaitIdle();
//		_frameBuffers.clear();
//		_swapchain.reset();
